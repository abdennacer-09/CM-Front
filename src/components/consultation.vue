    ...
    <div class="globalConsultation">
        ...
        <div class="container consPrs">
            <div class="card-title titleCons">
                ...
                <span><h5>Nouveau Consultation</h5></span>
            </div>
            <div class="card">
                        ...
                        <div v-if="ordonnance" class="mt-2 mtField main-ord">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    ...
                                    <div id="imprmerOrdns4" class="fichOrdns">
                                        <div class="insidOrdns">
                                            <h3 class="text-center dateOrdns">{{dateNow | myDate}}</h3>
                                            <h3 class="nomPatOrd text-center" v-text="selectedPatient ? selectedPatient.nom : ''"></h3>
                                            <ul class="list-unstyled" v-bind:key="ordns._id" v-for="ordns in ordonnances">
                                                <li v-if="adding == false && ordns.consultation == idCons && activerTd" class="medicOrd">{{ordns.medicament}}</li>
                                                <li v-if="adding == false && ordns.consultation == idCons && activerTd">* {{ordns.quantite}} {{ordns.prise}} {{ordns.periode}} {{ordns.nbrParJour}} {{ordns.quand}}aé'</li>
                                            </ul>
                                            <br>
                                            <br>
                                    ...
                                    <br>
                                    <button @click.prevent="printContent4('imprmerOrdns4')" class="btn btn-primary addTas">Imprimer</button>
                                </div>
                            </div>
                        </div>
                                    ...
                                    <div class="table-responsive">
                                        <table class="main-table text-center table table-bordered">
                                            ...
                                            <tr v-bind:key="Appr._id" v-for="Appr in appareils">
                                                <td v-if="adding == false && Appr.consultation == idCons && activerTd">{{Appr.abdominal}}</td>
                                                <td v-if="adding == false && Appr.consultation == idCons && activerTd">{{Appr.pleuropulmonaire}}</td>
                                                <td v-if="adding == false && Appr.consultation == idCons && activerTd">{{Appr.cardiovasculaire}}</td>
                                                <td v-if="adding == false && Appr.consultation == idCons && activerTd">{{Appr.gynecologique}}</td>
                                                <td v-if="adding == false && Appr.consultation == idCons && activerTd">{{Appr.osteoarticulaire}}</td>
                                                <td v-if="adding == false && Appr.consultation == idCons && activerTd">{{Appr.reste}}</td>
                                                <td v-if="adding == false && Appr.consultation == idCons && activerTd">
                        ...
                        <div class="table-responsive col-md-12">
                            <table class="main-table text-center table table-bordered">
                                ...
                                <tr v-bind:key="bio._id" v-for="bio in biologies">
                                    <td v-if=" adding == false && bio.consultation == idCons && activerTd">{{bio.NfsPq}}</td>
                                    <td v-if=" adding == false && bio.consultation == idCons && activerTd">
                                        <tr>
                                            <td>{{bio.TSHus}}</td>
                                            <td>{{bio.T3}}</td>
                                            <td>{{bio.T4}}</td>
                                    ...
                                    <td v-if=" adding == false && bio.consultation == idCons && activerTd">{{bio.Glycemie}}</td>
                                    <td v-if=" adding == false && bio.consultation == idCons && activerTd">{{bio.HBGA1c}}</td>
                                    <td v-if=" adding == false && bio.consultation == idCons && activerTd">
                                        <tr>
                                            <td>{{bio.LDL}}</td>
                                            <td>{{bio.HDL}}</td>
                                    ...
                                    <td v-if=" adding == false && bio.consultation == idCons && activerTd">{{bio.PSA}}</td>
                                    <td v-if=" adding == false && bio.consultation == idCons && activerTd">
                                        <tr>
                                            <td>{{bio.TP}}</td>
                                            <td>{{bio.TCK}}</td>
                                    ...
                                    <td v-if=" adding == false && bio.consultation == idCons && activerTd">{{bio.Groupage}}</td>
                                    <td v-if=" adding == false && bio.consultation == idCons && activerTd">
                                        <tr>
                                            <td>{{bio.TPHA}}</td>
                                            <td>{{bio.VDRL}}</td>
                                    ...
                                    <td v-if=" adding == false && bio.consultation == idCons && activerTd">{{bio.SerologieToxo}}</td>
                                    <td v-if=" adding == false && bio.consultation == idCons && activerTd">{{bio.SerologieRub}}</td>
                                    <td v-if=" adding == false && bio.consultation == idCons && activerTd">{{bio.AutresBio}}</td>
                                    <td v-if=" adding == false && bio.consultation == idCons && activerTd">
                                    ...
                                    <div class="table-responsive">
                                        <table class="main-table text-center table table-bordered">
                                            ...
                                            <tr v-bind:key="foi._id" v-for="foi in foies">
                                                <td v-if=" adding == false && foi.consultation == idCons && activerTd">{{foi.tailleFoi}}</td>
                                                <td v-if=" adding == false && foi.consultation == idCons && activerTd">{{foi.structureFoi}}</td>
                                                <td v-if=" adding == false && foi.consultation == idCons && activerTd">{{foi.contoursFoi}}</td>
                                                <td v-if=" adding == false && foi.consultation == idCons && activerTd">{{foi.autresAnomalies}}</td>
                                                <td v-if=" adding == false && foi.consultation == idCons && activerTd">
                                    ...
                                    <div class="table-responsive">
                                        <table class="main-table text-center table table-bordered">
                                            ...
                                            <tr v-bind:key="vesic._id" v-for="vesic in vesicules">
                                                <td v-if=" adding == false && vesic.consultation == idCons && activerTd"> {{ vesic.tailleVsB }} </td>
                                                <td v-if=" adding == false && vesic.consultation == idCons && activerTd">{{ vesic.paroisVsB }}</td>
                                                <td v-if=" adding == false && vesic.consultation == idCons && activerTd"> {{ vesic.formeVsB }} </td>
                                                <td v-if=" adding == false && vesic.consultation == idCons && activerTd">{{ vesic.autresVsB }}</td>
                                                <td v-if=" adding == false && vesic.consultation == idCons && activerTd">
                                    ...
                                    <div class="table-responsive">
                                        <table class="main-table text-center table table-bordered">
                                            ...
                                            <tr v-bind:key="voi._id" v-for="voi in voies">
                                                <td v-if=" adding == false && voi.consultation == idCons && activerTd">{{ voi.intrahEpatique }}</td>
                                                <td v-if=" adding == false && voi.consultation == idCons && activerTd">{{ voi.extrahepatique }}</td>
                                                <td v-if=" adding == false && voi.consultation == idCons && activerTd">
                                    ...
                                    <div class="table-responsive">
                                        <table class="main-table text-center table table-bordered">
                                            ...
                                            <tr v-bind:key="rat._id" v-for="rat in rates">
                                                <td v-if=" adding == false && rat.consultation == idCons && activerTd">{{rat.tailleRat}}</td>
                                                <td v-if=" adding == false && rat.consultation == idCons && activerTd">{{rat.structureRat}}</td>
                                                <td v-if=" adding == false && rat.consultation == idCons && activerTd">{{rat.contoursRat}}</td>
                                                <td v-if=" adding == false && rat.consultation == idCons && activerTd">{{rat.autresAnomaliesRat}}</td>
                                                <td v-if=" adding == false && rat.consultation == idCons && activerTd">
                                    ...
                                    <div class="table-responsive">
                                        <table class="main-table text-center table table-bordered">
                                            ...
                                            <tr v-bind:key="reinDr._id" v-for="reinDr in reinsDroit">
                                                <td v-if=" adding == false && reinDr.consultation == idCons && activerTd">{{reinDr.dimensions}}</td>
                                                <td v-if=" adding == false && reinDr.consultation == idCons && activerTd">{{reinDr.differenciation}}</td>
                                                <td v-if=" adding == false && reinDr.consultation == idCons && activerTd">{{reinDr.dilatation}}</td>
                                                <td v-if=" adding == false && reinDr.consultation == idCons && activerTd">
                                    ...
                                    <div class="table-responsive">
                                        <table class="main-table text-center table table-bordered">
                                            ...
                                            <tr v-bind:key="reinGch._id" v-for="reinGch in reinsGauche">
                                                <td v-if=" adding == false && reinGch.consultation == idCons && activerTd">{{reinGch.dimensionsGch}}</td>
                                                <td v-if=" adding == false && reinGch.consultation == idCons && activerTd">{{reinGch.differenciationGch}}</td>
                                                <td v-if=" adding == false && reinGch.consultation == idCons && activerTd">{{reinGch.dilatationGch}}</td>
                                                <td v-if=" adding == false && reinGch.consultation == idCons && activerTd">
                                    ...
                                    <div class="table-responsive">
                                        <table class="main-table text-center table table-bordered">
                                            ...
                                            <tr v-bind:key="ves._id" v-for="ves in vessies">
                                                <td v-if=" adding == false && ves.consultation == idCons && activerTd">{{ves.repletion}}</td>
                                                <td v-if=" adding == false && ves.consultation == idCons && activerTd">{{ves.contenu}}</td>
                                                <td v-if=" adding == false && ves.consultation == idCons && activerTd">{{ves.parois}}</td>
                                                <td v-if=" adding == false && ves.consultation == idCons && activerTd">{{ves.residuPostMictionnel}}</td>
                                                <td v-if=" adding == false && ves.consultation == idCons && activerTd">
                                    ...
                                    <div class="table-responsive">
                                        <table class="main-table text-center table table-bordered">
                                            ...
                                            <tr v-bind:key="pros._id" v-for="pros in prostates">
                                                <td v-if=" adding == false && pros.consultation == idCons && activerTd">{{pros.dimensionsPrs}}</td>
                                                <td v-if=" adding == false && pros.consultation == idCons && activerTd">{{pros.volumePrs}}</td>
                                                <td v-if=" adding == false && pros.consultation == idCons && activerTd">{{pros.echostructurePrs}}</td>
                                                <td v-if=" adding == false && pros.consultation == idCons && activerTd">{{pros.contoursPrs}}</td>
                                                <td v-if=" adding == false && pros.consultation == idCons && activerTd">
                                    ...
                                    <div class="table-responsive">
                                        <table class="main-table text-center table table-bordered">
                                            ...
                                            <tr v-bind:key="testicGch._id" v-for="testicGch in testiculesGch">
                                                <td v-if=" adding == false && testicGch.consultation == idCons && activerTd">{{testicGch.mmGch}}</td>
                                                <td v-if=" adding == false && testicGch.consultation == idCons && activerTd">{{testicGch.contoursGch}}</td>
                                                <td v-if=" adding == false && testicGch.consultation == idCons && activerTd">{{testicGch.echostructureGch}}</td>
                                                <td v-if=" adding == false && testicGch.consultation == idCons && activerTd">{{testicGch.AvEcDpCGch}}</td>
                                                <td v-if=" adding == false && testicGch.consultation == idCons && activerTd">
                                    ...
                                    <div class="table-responsive">
                                        <table class="main-table text-center table table-bordered">
                                            ...
                                            <tr v-bind:key="testicDr._id" v-for="testicDr in testiculesDr">
                                                <td v-if=" adding == false && testicDr.consultation == idCons && activerTd">{{testicDr.mmDr}}</td>
                                                <td v-if=" adding == false && testicDr.consultation == idCons && activerTd">{{testicDr.contoursDr}}</td>
                                                <td v-if=" adding == false && testicDr.consultation == idCons && activerTd">{{testicDr.echostructureDr}}</td>
                                                <td v-if=" adding == false && testicDr.consultation == idCons && activerTd">{{testicDr.AvEcDpCDr}}</td>
                                                <td v-if=" adding == false && testicDr.consultation == idCons && activerTd">
                                    ...
                                    <div class="table-responsive">
                                        <table class="main-table text-center table table-bordered">
                                            ...
                                            <tr v-bind:key="epid._id" v-for="epid in epididymes">
                                                <td v-if=" adding == false && epid.consultation == idCons && activerTd">{{epid.epidDr}}</td>
                                                <td v-if=" adding == false && epid.consultation == idCons && activerTd">{{epid.epidGch}}</td>
                                                <td v-if=" adding == false && epid.consultation == idCons && activerTd">
                                    ...
                                    <div class="table-responsive">
                                        <table class="main-table text-center table table-bordered">
                                            ...
                                            <tr v-bind:key="hydr._id" v-for="hydr in hydroceles">
                                                <td v-if=" adding == false && hydr.consultation == idCons && activerTd">{{hydr.hydrDr}}</td>
                                                <td v-if=" adding == false && hydr.consultation == idCons && activerTd">{{hydr.hydrGch}}</td>
                                                <td v-if=" adding == false && hydr.consultation == idCons && activerTd">
                                    ...
                                    <div class="table-responsive">
                                        <table class="main-table text-center table table-bordered">
                                            ...
                                            <tr v-bind:key="varic._id" v-for="varic in varicoceles">
                                                <td v-if=" adding == false && varic.consultation == idCons && activerTd">{{varic.varicDr}}</td>
                                                <td v-if=" adding == false && varic.consultation == idCons && activerTd">{{varic.varicGch}}</td>
                                                <td v-if=" adding == false && varic.consultation == idCons && activerTd">
                                    ...
                                    <div class="table-responsive">
                                        <table class="main-table text-center table table-bordered">
                                            ...
                                            <tr v-bind:key="panc._id" v-for="panc in pancreases">
                                                <td v-if=" adding == false && panc.consultation == idCons && activerTd">{{panc.pancreas}}</td>
                                                <td v-if=" adding == false && panc.consultation == idCons && activerTd">{{panc.rmqPancreas}}</td>
                                                <td v-if=" adding == false && panc.consultation == idCons && activerTd">
                                    ...
                                    <div class="table-responsive">
                                        <table class="main-table text-center table table-bordered">
                                            ...
                                            <tr v-bind:key="sac._id" v-for="sac in sacGests">
                                                <td v-if=" adding == false && sac.consultation == idCons && activerTd">{{sac.nombre}}</td>
                                                <td v-if=" adding == false && sac.consultation == idCons && activerTd">{{sac.position}}</td>
                                                <td v-if=" adding == false && sac.consultation == idCons && activerTd">{{sac.forme}}</td>
                                                <td v-if=" adding == false && sac.consultation == idCons && activerTd">{{sac.diametre}}</td>
                                                <td v-if=" adding == false && sac.consultation == idCons && activerTd">
                                        ...
                                        <div class="table-responsive">
                                            <table class="main-table text-center table table-bordered">
                                                ...
                                                <tr v-bind:key="mens._id" v-for="mens in mensurations">
                                                    <td v-if=" adding == false && mens.consultation == idCons && activerTd">{{mens.lcc}}</td>
                                                    <td v-if=" adding == false && mens.consultation == idCons && activerTd">{{mens.bip}}</td>
                                                    <td v-if=" adding == false && mens.consultation == idCons && activerTd">{{mens.fl}}</td>
                                                    <td v-if=" adding == false && mens.consultation == idCons && activerTd">{{mens.dat}}</td>
                                                    <td v-if=" adding == false && mens.consultation == idCons && activerTd">{{mens.hc}}</td>
                                                    <td v-if=" adding == false && mens.consultation == idCons && activerTd">{{mens.autresMens}}</td>
                                                    <td v-if=" adding == false && mens.consultation == idCons && activerTd">
                                    ...
                                    <div class="table-responsive">
                                        <table class="main-table text-center table table-bordered">
                                            ...
                                            <tr v-bind:key="embr._id" v-for="embr in embryons">
                                                <td v-if=" adding == false && embr.consultation == idCons && activerTd">{{ embr.positionEmb }}</td>
                                                <td v-if=" adding == false && embr.consultation == idCons && activerTd">
                                                    <tr>
                                                        <td>{{embr.activiteCardiaque}}</td>
                                                        <td>{{embr.fcActiv}}</td>
                                                    </tr>
                                                </td>
                                                <td v-if=" adding == false && embr.consultation == idCons && activerTd">{{embr.mouvementFoetus}}</td>
                                                <td v-if=" adding == false && embr.consultation == idCons && activerTd">{{embr.liquideAmniotique}}</td>
                                                <td v-if=" adding == false && embr.consultation == idCons && activerTd">
                                                    <tr>
                                                ...
                                                <td v-if=" adding == false && embr.consultation == idCons && activerTd">{{embr.ageGestationnel}}</td>
                                                <td v-if=" adding == false && embr.consultation == idCons && activerTd">{{embr.datePresume}}</td>
                                                <td v-if=" adding == false && embr.consultation == idCons && activerTd">
                                    ...
                                    <div class="table-responsive">
                                        <table class="main-table text-center table table-bordered">
                                            ...
                                            <tr v-bind:key="autreRad._id" v-for="autreRad in autresRadio2">
                                                <td v-if=" adding == false && autreRad.consultation == idCons && activerTd">{{autreRad.ecg}}</td>
                                                <td v-if=" adding == false && autreRad.consultation == idCons && activerTd">{{autreRad.radioThoracique}}</td>
                                                <td v-if=" adding == false && autreRad.consultation == idCons && activerTd">{{autreRad.scanner}}</td>
                                                <td v-if=" adding == false && autreRad.consultation == idCons && activerTd">{{autreRad.irm}}</td>
                                                <td v-if=" adding == false && autreRad.consultation == idCons && activerTd">
